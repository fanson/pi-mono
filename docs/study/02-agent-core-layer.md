...
> **源码对照**: `packages/agent/src/agent.ts` — Agent L157, prompt() L312, steer() L249
...
> **源码对照**: `packages/agent/src/types.ts` — AgentMessage L245, AgentTool L292, AgentLoopConfig L96, AgentEvent L326
