...
> **源码对照**: `packages/coding-agent/src/core/compaction/compaction.ts` — `compact`、`findCutPoint`、`generateSummary`
...
> **源码对照**: `packages/coding-agent/src/core/session-manager.ts` — `SessionManager`、`appendMessage`、`getBranch`、`branch`
